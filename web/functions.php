...
require('../vendor/autoload.php'); // TODO add/remove comment
...
function create_scrapbook()
{
  ...
  <form class="form-signin" method="post">
    ...
    <input name="title" type="text" id="inputTitle" class="form-control" placeholder="New Scrapbook" required autofocus>
    <label for="inputDescription" class="sr-only">Description</label>
    <input name="description" type="text" id="inputDescription" class="form-control">
    <label for="inputPublicity" class="sr-only">Public</label>
    <input name="public" type="checkbox" id="inputPublicity" class="form-control">
